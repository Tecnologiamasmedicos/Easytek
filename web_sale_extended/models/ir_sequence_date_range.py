...
class IrSequenceDateRange(models.Model):
    _inherit = 'ir.sequence_date_range'
    ...
    number_next_actual = fields.Float(string='Número Siguiente Real', help="Próximo número que se utilizará. Este número puede incrementarse frecuentemente por lo que el valor mostrado puede estar ya obsoleto.", size=15, digits=(15, 0))
