...
#         return True
    ...
    def _cron_payment_invoice(self):
        invoices_ids = self.env['account.move'].search([('amount_residual', '>', 0), ('type', '=', 'out_invoice'), ('state', '=', 'posted'), ('journal_id', '=', 11)])
        _logger.error('Facturasssss')
        _logger.error(invoices_ids)
